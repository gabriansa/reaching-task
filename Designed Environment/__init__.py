...
# Reaching
for robot in ['Sawyer', 'Jaco']:
    register(
        id='Reaching%s-v1' % robot,
        entry_point='assistive_gym.envs:Reaching%sEnv' % robot,
        max_episode_steps=200,
    )
...
for robot in ['Sawyer', 'Jaco']:
    register(
        id='Passing%s-v1' % robot,
        entry_point='assistive_gym.envs:Passing%sEnv' % robot,
        max_episode_steps=200,
    )
    ...
    while not is_pointing:
        ...
        if len(wrist_pos_real_LIST) > observation_range_pointing:
            ...
            if steady_count >= observation_range_steady-6 and pointing_count == observation_range_pointing-1:
                if wrist_pos_real_LIST[-1][0] > neck_pos_real_LIST[-1][0]*5/7 and wrist_pos_real_LIST[-1][0] > shoulder_pos_real_LIST[-1][0]*8/9:
                    marker_color = 'BLUE'
                    is_pointing = True
...
def ZED_to_Sawyer_coordinate(ZED_point):
    ...
    R = [[-0.99128586, -0.01385658,  0.01928448],
         [-0.05860864, -0.01511304, -0.99264368],
         [ 0.00537254, -1.00281869, -0.00139888]]

    T = [0.53633994, 0.93991991, 0.80827341]
